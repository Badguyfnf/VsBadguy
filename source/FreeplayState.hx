...
class FreeplayState extends MusicBeatState
{
	...
	private static var lastDifficultyName:String = 'hell';
	...
	override function create()
	{
		switch (FreeplaySelectState.freeplayCats[FreeplaySelectState.curCategory].toLowerCase())
		{
			...
			case 'non-story':
				addWeek(['purpled', 'powerful', 'bulletation'], 1, 0xff00c3ff, ['badguy', 'badguy', 'mc']);
			case 'covers':
				addWeek(['devils-gambit'], 0, 0xFFce3c80, ['badn']);
			case 'secrets':
		...
		{
			var songText:Alphabet = new Alphabet(0, (40 * i), songs[i].songName, true);
